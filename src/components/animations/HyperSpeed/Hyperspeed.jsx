...
const Hyperspeed = ({ isDarkMode, effectOptions = {
  onSpeedUp: () => { },
  onSlowDown: () => { },
  ...
  colors: {
    roadColor: isDarkMode ? 0x000000 : 0xFFFFFF,
    ...
    leftCars: isDarkMode ? [0xD856BF, 0x6750A2, 0xC247AC] : [0xFF69B4, 0x9370DB, 0xFFB6C1],
    rightCars: isDarkMode ? [0x03B3C3, 0x0E5EA5, 0x324555] : [0x00CED1, 0x4682B4, 0x87CEEB],
    sticks: 0x03B3C3,
  }
} }) => {
