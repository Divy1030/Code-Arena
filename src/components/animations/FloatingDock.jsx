...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={`ml-auto hidden md:flex h-16 gap-4 items-end rounded-2xl bg-gray-50 dark:bg-neutral-900 px-4 pb-3 ${className}`}>
      {items.map((item) => (
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer">
      <motion.div
        ...
        className="aspect-square rounded-full bg-[#0e054d] dark:bg-neutral-800 flex items-center justify-center relative">
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className="px-2 py-0.5 whitespace-pre rounded-md border dark:bg-neutral-800 dark:border-neutral-900 dark:text-white  text-white absolute left-1/2 -translate-x-1/2 -top-8 w-fit text-xs">
              {title}
            </motion.div>
          )}
        </AnimatePresence>
