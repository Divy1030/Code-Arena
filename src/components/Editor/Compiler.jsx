...
import { ChevronDown, Play, RefreshCcw, Settings, Trophy, Award, Maximize2, Minimize2 } from 'lucide-react';
...
const Compiler = () => {
  ...
  return (
    <div className={`min-h-screen bg-[#0f1117] text-white ${isFullScreen ? 'fixed inset-0 z-50' : ''}`}>
      {/* Navigation Bar */}
      <nav className="flex justify-between items-center p-4 bg-[#1a1d27]">
      ...
      <div className="flex h-full">
        {/* Code Editor Section */}
        <div className={`w-1/2 p-4 ${isFullScreen ? 'w-full' : 'w-1/2'}`}>
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-4">
              <RefreshCcw size={16} className="text-gray-400" onClick={resetCode} />
              <Settings size={16} className="text-gray-400" onClick={toggleSettings} />
              {isFullScreen ? (
                <Minimize2 size={16} className="text-gray-400" onClick={toggleFullScreen} />
              ) : (
                <Maximize2 size={16} className="text-gray-400" onClick={toggleFullScreen} />
              )}
          ...
          {showSettings && (
            <div className="bg-[#1a1d27] p-4 rounded-lg mb-4">
              <div className="mb-4">
          ...
          <div className="bg-[#1a1d27] p-4 rounded-lg h-96 mb-4 overflow-auto">
            <CodeMirror
              value={code}
              extensions={[language]}
              onChange={(value) => {
          ...
          <div className="mt-[1.5rem]">
            ...
            <div className="bg-[#1a1d27] p-4 rounded-lg max-h-48 overflow-y-auto">
          ...
          <div className="w-1/2 p-4">
            <div className="h-full pr-4">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center gap-4">
                  <span className="text-green-500 px-2 py-1 rounded text-sm">Easy</span>
                  <span className="text-gray-400">15 mins</span>
                  <span className="text-gray-400">100 points</span>
                </div>
              </div>

              <div className="bg-[#1a1d27] p-4 rounded-lg mb-4 overflow-y-auto max-h-[30rem]">
                ...
                <div className="bg-[#12141c] p-4 rounded mb-4">
